...
class LoadingAnimationWidget1 extends StatefulWidget {
  const LoadingAnimationWidget1({super.key});

  @override
  State<LoadingAnimationWidget1> createState() =>
      _LoadingAnimationWidget1State();
}

class _LoadingAnimationWidget1State extends State<LoadingAnimationWidget1>
